...
import * as payments2 from '@/app/server/finances/payments' // This import caused an error and has been replaced with mock data.
...
export function ViewVinculePayment({ open, onClose, itemId, onSelected }) {
  ...
  const fetchData = async (start, end) => {
    setLoading(true);
    try {
      const items = await payments2.findAll({
        limit: 50,
        offset: 0,
        dueDate: {
